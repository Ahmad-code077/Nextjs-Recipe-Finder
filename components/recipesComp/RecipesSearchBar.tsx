    ...
    <div className='my-8'>
      ...
      <div className='flex items-center'>
        <input
          ...
          className='px-6 py-3 w-96 text-lg border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary transition-all ease-in-out text-black'
        />
      </div>
    </div>
  );
