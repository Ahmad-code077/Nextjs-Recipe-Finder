...
const DeleteRecipePopup: React.FC<DeleteRecipePopupProps> = ({
  ...
  return (
    <div className='fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50'>
      <div className='bg-black rounded-lg shadow-md sm:w-[400px] p-6'>
  ...
  return (
    <>
      <button
        ...
        className='px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2 transition'
      >
        Delete
      </button>
